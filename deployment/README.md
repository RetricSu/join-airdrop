...
offckb deploy --network devnet --target <contract-binary-path> --output /Users/retric/Desktop/join-airdrop/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Users/retric/Desktop/join-airdrop/deployment
```
